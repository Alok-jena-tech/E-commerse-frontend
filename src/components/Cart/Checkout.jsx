...
const Checkout = () => {
  ...
  const [checkoutId, setCheckoutId] = useState(null); //after payment it will be set
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-[88vw]  mx-auto py-10 px-6 tracking-tighter ">
      {/* left section */}
            ...
            {!checkoutId ? (
              ...
              <div>
                ...
                <PayPalButton
                  ...
                  onError={() => alert("Paymeny failed.Try again")}
                />
              </div>
            )}
          </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg">
        ...
        <div className="border-t py-4 mb-4">
          {cart.products.map((product, index) => (
            <div key={index} className="flex justify-between py-2 items-start">
